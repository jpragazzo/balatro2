...
var player_deck = ["skeleton", "chicken", "sword", "cap", "money", "money", "money", "money", "money", "money", "money", "money", "money", "money"] #nomes dos pngs precisam ser iguais aos dos .tres
